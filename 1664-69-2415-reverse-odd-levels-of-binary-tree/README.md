<h2> 1664 69
2415. Reverse Odd Levels of Binary Tree</h2><hr><div><p>Given the <code>root</code> of a <strong>perfect</strong> binary tree, reverse the node values at each <strong>odd</strong> level of the tree.</p>
